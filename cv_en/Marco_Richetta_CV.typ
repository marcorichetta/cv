...
#one-col-entry(
  content: [I like to share knowledge by #link("https://www.youtube.com/live/EWofHnNngoc?si=1OpnvzkN-R0NSc2i")[giving] #link("https://www.linkedin.com/in/marco-richetta/overlay/experience/2020463733/multiple-media-viewer/?profileId=ACoAABQf7hUBZUJgMc0bcZABQZwPRzETisnwoTM&treasuryMediaId=1635515512870")[talks], also as a #link("https://frontend.cafe/mentorias")[mentor] or simply helping others to solve problems. #link("https://forum.djangoproject.com/u/marcorichetta/summary")[E.g. the Django forum].]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [Currently interested in enhancing #strong[Developer Experience \(DX\)] through IaC. Also learning about Go, MLOps, Elixir.]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [My background is in backend but I like to look at the bigger picture and think beyond my specific role. Curiosity drives me but I'm always learning to balance it and prioritize impact.]
)
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Worked improving #strong[Python DX], maintaining tooling used by thousands of developers in the company. \(General support, features, bugfixes, version deprecation\).],[Building on our Python expertise, we led upgrades for over 1,000 outdated Java applications and libraries using #link("https://sourcegraph.com/batch-changes")[Large-Scale Code Changes], managing the roadmap and collaborating with responsible teams to implement and monitor each update.],)
  ],
)
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Fullstack development \(#strong[React\/Django]\) to integrate 3rd party systems with internal company applications.],[Later, in a more #strong[DevOps] role, I helped in the migration of the internal infrastructure to Kubernetes applying #strong[GitOps]. This also led to better DX.],)
  ],
)
...
#three-col-entry(
  ...
  middle-content: [
     #strong[Computer Systems Analyst], Instituto Superior 25 de Mayo -- Córdoba, Argentina
  ],
  right-content: [
    Feb 2015 - Dec 2020
  ],
...
#one-col-entry(
  content: [#strong[Hack Your Future:] Joined as a Technical mentor to help people kickstart their programming carreers. - #link("https://www.hackyourfuture.dk/")[https:\/\/www.hackyourfuture.dk\/]]
)
...
#one-col-entry(
  content: [#strong[Languages:] Python, React, JavaScript\/Typescript, Go]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [#strong[Technologies:] Django, Pytest, Kubernetes, FluxCD, Docker, OpenTelemetry]
)
